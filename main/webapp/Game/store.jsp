                    ...
                    <div class="col-lg-8">
                        <div class="featured-games header-text">
                            ...
                            <div class="owl-features owl-carousel">
                                <div class="item">
                                    <div class="thumb">
                                        <img src="/public/assets/images/featured-01.jpg" alt="">
                                ...
                                <div class="item">
                                    <div class="thumb">
                                        <img src="/public/assets/images/featured-02.jpg" alt="">
                                        <div class="hover-effect">
                                            <h6>2.4K Streaming</h6>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="thumb">
                                        <img src="/public/assets/images/featured-03.jpg" alt="">
                                        <div class="hover-effect">
                                            <h6>2.4K Streaming</h6>
                                        </div>
                                    </div>
                ...
                <div class="live-stream">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="item">
                                <div class="thumb">
                                    <img src="/public/assets/images/stream-05.jpg" alt="">
                                    <div class="hover-effect">
                                        <div class="content">
                                            <div class="live">
                                                <a href="#">Live</a>
                                ...
                                <div class="down-content">
                                    <div class="avatar">
                                        <img src="/public/assets/images/avatar-01.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="item">
                                <div class="thumb">
                                    <img src="/public/assets/images/stream-06.jpg" alt="">
                                    <div class="hover-effect">
                                        <div class="content">
                                            <div class="live">
                                                <a href="#">Live</a>
                                ...
                                <div class="down-content">
                                    <div class="avatar">
                                        <img src="/public/assets/images/avatar-02.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="item">
                                <div class="thumb">
                                    <img src="/public/assets/images/stream-07.jpg" alt="">
                                    <div class="hover-effect">
                                        <div class="content">
                                            <div class="live">
                                                <a href="#">Live</a>
                                ...
                                <div class="down-content">
                                    <div class="avatar">
                                        <img src="/public/assets/images/avatar-03.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="item">
                                <div class="thumb">
                                    <img src="/public/assets/images/stream-08.jpg" alt="">
                                    <div class="hover-effect">
                                        <div class="content">
                                            <div class="live">
                                                <a href="#">Live</a>
                                ...
                                <div class="down-content">
                                    <div class="avatar">
                                        <img src="/public/assets/images/avatar-04.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                                    </div>
